      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            It’s time to get smarter about bidding
          </h2>
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            VFX bidding today is slow, manual, and inconsistent, leading to cost overruns, underbidding, and wasted time for supervisors and producers
